...
export default function LandingPage({ onEnterApp, language }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <section className="relative py-24 px-8 bg-gradient-to-b from-[#242424] to-[#1a1a1a] overflow-hidden">
        {/* Decorative Elements */}
      ...
      {/* Conversion Section */}
      <section className="relative py-24 px-8 bg-[#1a1a1a] overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          {/* Decorative line */}
          <div className="w-20 h-1 bg-gradient-to-r from-transparent via-[#27F5A9] to-transparent mx-auto mb-8"></div>
